...
# --- MAIN LAYOUT ---
st.title("≡ƒñû XAUUSD AI Live Trader")
...
while True:
    ...
    with placeholder.container():
        if state is None:
            st.warning("ΓÜá∩╕Å Waiting for Bot State... (Ensure main.py is running)")
        else:
            # Header Metrics
            ...
            # Signals Section
            st.subheader("≡ƒôí Signal Analysis")
            ...
            # Trade Setup Section
            st.subheader("≡ƒÄ» Potential Trade Setup")
